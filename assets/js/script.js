...
function burgerMenuPc(selector) {
    let menu = $(selector);
    let button = menu.find(".burger-pc-menu-button");
    let links = menu.find(".pc-link");
    let overlay = menu.find("burger-pc-menu_overlay");
    button.on("click",(e) => {
        e.preventDefault();
        toogleMenu();
    });
